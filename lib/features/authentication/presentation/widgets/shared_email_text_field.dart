...
class SharedEmailTextField extends StatelessWidget {
  const SharedEmailTextField({super.key, required this.emailController, required this.text});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(text,style: getRegularTextStyle(fontSize: 15,color: AppColors.blackText),),
          10.vs,
          CustomTextFormField(
