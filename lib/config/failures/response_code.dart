...
abstract class ResponseCode {
  ...
  static const int CACHE_REMOVE_SUCCESS = 0;
  ...
  static const int INVALIDINPUT = 422;
  ...
  static const int CACHE_REMOVE_ERROR = -10;

  /// Indicates no internet connection is available.
  static const int NO_INTERNET_CONNECTION = -11;
}
